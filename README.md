...
### Train
1. Add [pretrained models](https://cloudstor.aarnet.edu.au/plus/s/LqqdgwJ69NEdnDS) on the FER-2013 dataset
...
### Test
1. Add [trained models](https://cloudstor.aarnet.edu.au/plus/s/i3oPqcjXhG7Ymva) on the ER dataset
2. Run the model's script:
````
